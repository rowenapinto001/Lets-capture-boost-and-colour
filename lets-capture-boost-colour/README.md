...
4. Select the `lets-capture-boost-colour` folder
...
2. From the parent directory, zip the `lets-capture-boost-colour` folder contents (not the parent folder itself) — e.g. `zip -r lets-capture-boost-colour.zip lets-capture-boost-colour`.
